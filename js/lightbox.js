...
function open_lb(id){
    $('body').append('<div id="AI_lightbox"><span class="closeLB"><i class="material-icons">&#xE5CD;</i></span><img src="" alt="" /><span class="prev"><i class="material-icons">&#xE5CB;</i></span><span class="next"><i class="material-icons">&#xE5CC;</i></span></div>');
  ...
  $(document).on('click','#AI_lightbox .closeLB',function(){
